...
wire   [23:0] tmp_data_V_fu_536_p4;
wire   [0:0] tmp_last_V_fu_553_p2;
reg   [9:0] col_reg_284;
reg   [8:0] row_reg_295;
reg   [9:0] col_1_reg_306;
reg   [7:0] swin_0_1_V_fu_180;
reg   [7:0] swin_0_1_V_1_fu_184;
reg   [7:0] tmp_V_fu_188;
reg   [7:0] swin_1_0_V_fu_192;
reg   [7:0] swin_1_1_V_fu_196;
reg   [7:0] tmp_V_1_fu_200;
reg   [7:0] swin_2_0_V_fu_204;
reg   [7:0] swin_2_1_V_fu_208;
wire   [7:0] swin_2_2_V_fu_435_p4;
wire   [7:0] p_Result_s_fu_389_p4;
wire   [7:0] p_Result_1_fu_399_p4;
wire   [8:0] rhs_V_cast_fu_413_p1;
wire   [8:0] lhs_V_cast_fu_409_p1;
wire   [8:0] ret_V_fu_417_p2;
wire   [7:0] tmp_1_fu_423_p1;
wire   [21:0] grp_fu_599_p3;
wire   [8:0] lhs_V_3_cast_fu_448_p1;
wire   [8:0] lhs_V_2_cast_fu_444_p1;
wire   [8:0] lhs_V_4_cast_fu_458_p1;
wire   [8:0] ret_V_2_fu_452_p2;
wire   [8:0] ret_V_3_fu_462_p2;
wire  signed [9:0] lhs_V_5_cast_fu_468_p1;
wire  signed [9:0] rhs_V_3_cast_fu_472_p1;
wire   [9:0] ret_V_4_fu_476_p2;
wire   [9:0] rhs_V_4_cast_fu_482_p1;
wire   [9:0] ret_V_5_fu_486_p2;
wire   [0:0] tmp_4_fu_492_p3;
wire   [9:0] p_s_fu_500_p3;
wire   [1:0] tmp_9_fu_508_p4;
wire   [0:0] icmp_fu_518_p2;
wire   [7:0] tmp_10_fu_524_p1;
wire   [7:0] tmp_8_fu_528_p3;
wire   [0:0] tmp_3_fu_547_p2;
wire   [8:0] grp_fu_599_p0;
wire   [7:0] grp_fu_599_p1;
wire   [11:0] grp_fu_599_p2;
reg   [4:0] ap_NS_fsm;
wire   [9:0] grp_fu_599_p00;
wire   [9:0] grp_fu_599_p10;
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((out_V_dest_V_1_ack_in == 1'b0) | (out_V_id_V_1_ack_in == 1'b0) | (out_V_last_V_1_ack_in == 1'b0) | (out_V_user_V_1_ack_in == 1'b0) | (out_V_strb_V_1_ack_in == 1'b0) | (out_V_keep_V_1_ack_in == 1'b0) | (out_V_data_V_1_ack_in == 1'b0)) & (tmp_5_fu_329_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        col_1_reg_306 <= 10'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        col_reg_284 <= 10'd0;
    end else if ((~(((tmp_fu_317_p2 == 1'd1) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_fu_317_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        col_reg_284 <= col_2_fu_323_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((1'b1 == ap_block_state4_io) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (in_V_data_V_0_vld_out == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_7_fu_362_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        row_reg_295 <= row_1_reg_679;
    end else if ((~(((tmp_fu_317_p2 == 1'd1) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_fu_317_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        row_reg_295 <= 9'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((~((1'b1 == ap_block_state4_io) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (in_V_data_V_0_vld_out == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if ((~((1'b1 == ap_block_state4_io) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (in_V_data_V_0_vld_out == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_7_fu_362_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        ...
        swin_2_1_V_fu_208 <= {{grp_fu_599_p3[19:12]}};
...
always @ (posedge ap_clk) begin
    if ((~((out_V_dest_V_1_ack_in == 1'b0) | (out_V_id_V_1_ack_in == 1'b0) | (out_V_last_V_1_ack_in == 1'b0) | (out_V_user_V_1_ack_in == 1'b0) | (out_V_strb_V_1_ack_in == 1'b0) | (out_V_keep_V_1_ack_in == 1'b0) | (out_V_data_V_1_ack_in == 1'b0)) & (tmp_5_fu_329_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        tmp_6_reg_684 <= tmp_6_fu_341_p2;
    end
end

always @ (*) begin
    if ((~((out_V_dest_V_1_ack_in == 1'b0) | (out_V_id_V_1_ack_in == 1'b0) | (out_V_last_V_1_ack_in == 1'b0) | (out_V_user_V_1_ack_in == 1'b0) | (out_V_strb_V_1_ack_in == 1'b0) | (out_V_keep_V_1_ack_in == 1'b0) | (out_V_data_V_1_ack_in == 1'b0)) & (tmp_5_fu_329_p2 == 1'd1) & (out_V_dest_V_1_state[1'd0] == 1'b0) & (out_V_id_V_1_state[1'd0] == 1'b0) & (out_V_last_V_1_state[1'd0] == 1'b0) & (out_V_user_V_1_state[1'd0] == 1'b0) & (out_V_strb_V_1_state[1'd0] == 1'b0) & (out_V_keep_V_1_state[1'd0] == 1'b0) & (out_V_data_V_1_state[1'd0] == 1'b0) & (1'b1 == ap_CS_fsm_state3))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((~(((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (in_V_data_V_0_vld_out == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_7_fu_362_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((~(((tmp_fu_317_p2 == 1'd1) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_fu_317_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | (~((1'b1 == ap_block_state4_io) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (in_V_data_V_0_vld_out == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_7_fu_362_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4)))) begin
...
always @ (*) begin
    ...
    end else if (((~(((tmp_fu_317_p2 == 1'd1) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_fu_317_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | (~(((tmp_fu_317_p2 == 1'd1) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_fu_317_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
        buff2_V_V_din = 8'd0;
    end else begin
        buff2_V_V_din = 'bx;
    end
...
always @ (*) begin
    if (((~(((tmp_fu_317_p2 == 1'd1) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_fu_317_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | (~(((tmp_fu_317_p2 == 1'd1) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_fu_317_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | (~((1'b1 == ap_block_state4_io) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (in_V_data_V_0_vld_out == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_7_fu_362_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4)))) begin
...
always @ (*) begin
    if (((tmp_7_fu_362_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) | ((tmp_7_fu_362_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~(((tmp_fu_317_p2 == 1'd1) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_fu_317_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_state4 : begin
            if ((~((1'b1 == ap_block_state4_io) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (in_V_data_V_0_vld_out == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_7_fu_362_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else if ((~((1'b1 == ap_block_state4_io) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (in_V_data_V_0_vld_out == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0))) & (tmp_7_fu_362_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    ap_block_state2 = (((tmp_fu_317_p2 == 1'd1) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_fu_317_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_block_state4 = (((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_empty_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (in_V_data_V_0_vld_out == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff2_V_V_full_n == 1'b0)) | ((tmp_7_fu_362_p2 == 1'd0) & (buff1_V_V_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_state4_io = ((tmp_7_fu_362_p2 == 1'd0) & (out_V_data_V_1_ack_in == 1'b0));
end
...
assign col_2_fu_323_p2 = (col_reg_284 + 10'd1);

assign col_3_fu_368_p2 = (col_1_reg_306 + 10'd1);

assign grp_fu_599_p0 = grp_fu_599_p00;

assign grp_fu_599_p00 = ret_V_fu_417_p2;

assign grp_fu_599_p1 = grp_fu_599_p10;

assign grp_fu_599_p10 = tmp_1_fu_423_p1;

assign grp_fu_599_p2 = 22'd1366;

assign icmp_fu_518_p2 = ((tmp_9_fu_508_p4 == 2'd1) ? 1'b1 : 1'b0);
...
assign lhs_V_2_cast_fu_444_p1 = buff1_V_V_dout;

assign lhs_V_3_cast_fu_448_p1 = swin_0_1_V_fu_180;

assign lhs_V_4_cast_fu_458_p1 = swin_2_0_V_fu_204;

assign lhs_V_5_cast_fu_468_p1 = $signed(ret_V_2_fu_452_p2);

assign lhs_V_cast_fu_409_p1 = p_Result_s_fu_389_p4;
...
assign p_Result_1_fu_399_p4 = {{in_V_data_V_0_data_out[15:8]}};

assign p_Result_s_fu_389_p4 = {{in_V_data_V_0_data_out[23:16]}};

assign p_s_fu_500_p3 = ((tmp_4_fu_492_p3[0:0] === 1'b1) ? 10'd0 : ret_V_5_fu_486_p2);

assign ret_V_2_fu_452_p2 = (lhs_V_3_cast_fu_448_p1 - lhs_V_2_cast_fu_444_p1);

assign ret_V_3_fu_462_p2 = (9'd0 - lhs_V_4_cast_fu_458_p1);

assign ret_V_4_fu_476_p2 = ($signed(lhs_V_5_cast_fu_468_p1) + $signed(rhs_V_3_cast_fu_472_p1));

assign ret_V_5_fu_486_p2 = (ret_V_4_fu_476_p2 + rhs_V_4_cast_fu_482_p1);

assign ret_V_fu_417_p2 = (rhs_V_cast_fu_413_p1 + lhs_V_cast_fu_409_p1);

assign rhs_V_3_cast_fu_472_p1 = $signed(ret_V_3_fu_462_p2);

assign rhs_V_4_cast_fu_482_p1 = swin_2_2_V_fu_435_p4;

assign rhs_V_cast_fu_413_p1 = p_Result_1_fu_399_p4;

assign row_1_fu_335_p2 = (row_reg_295 + 9'd1);

assign swin_2_2_V_fu_435_p4 = {{grp_fu_599_p3[19:12]}};

assign tmp_10_fu_524_p1 = p_s_fu_500_p3[7:0];

assign tmp_1_fu_423_p1 = in_V_data_V_0_data_out[7:0];

assign tmp_3_fu_547_p2 = ((col_1_reg_306 == 10'd639) ? 1'b1 : 1'b0);

assign tmp_4_fu_492_p3 = ret_V_5_fu_486_p2[32'd9];

assign tmp_5_fu_329_p2 = ((row_reg_295 == 9'd480) ? 1'b1 : 1'b0);

assign tmp_6_fu_341_p2 = ((row_reg_295 == 9'd479) ? 1'b1 : 1'b0);

assign tmp_7_fu_362_p2 = ((col_1_reg_306 == 10'd640) ? 1'b1 : 1'b0);

assign tmp_8_fu_528_p3 = ((icmp_fu_518_p2[0:0] === 1'b1) ? 8'd255 : tmp_10_fu_524_p1);

assign tmp_9_fu_508_p4 = {{p_s_fu_500_p3[9:8]}};

assign tmp_data_V_fu_536_p4 = {{{tmp_8_fu_528_p3}, {tmp_8_fu_528_p3}}, {tmp_8_fu_528_p3}};

assign tmp_fu_317_p2 = ((col_reg_284 == 10'd637) ? 1'b1 : 1'b0);

assign tmp_last_V_fu_553_p2 = (tmp_6_reg_684 & tmp_3_fu_547_p2);
