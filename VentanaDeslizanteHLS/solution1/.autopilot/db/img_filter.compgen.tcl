...
set out_width 8
set exp i0*i1+i2
set arg_lists {i0 {8 1 +} i1 {3 1 +} m {8 1 +} i2 {8 0 +} p {8 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 8
set exp i0*i1+i2
set arg_lists {i0 {3 1 +} i1 {8 1 +} m {8 1 +} i2 {8 0 +} p {8 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set ID 7
set hasByteEnable 0
set MemName img_filter_kernelX
...
set ID 8
set hasByteEnable 0
set MemName img_filter_kernelY
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 3
set AddrRange 9
