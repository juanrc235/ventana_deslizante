...
// ==============================================================
#ifndef __img_filter_mac_mucud__HH__
#define __img_filter_mac_mucud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(img_filter_mac_mucud) {
    ...
    SC_CTOR(img_filter_mac_mucud):  simcore_mac_0_U ("simcore_mac_0_U") {
