...
// ==============================================================
#ifndef __img_filter_am_addbkb__HH__
#define __img_filter_am_addbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(img_filter_am_addbkb) {
    ...
    SC_CTOR(img_filter_am_addbkb):  simcore_am_0_U ("simcore_am_0_U") {
