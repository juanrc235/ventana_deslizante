...
`define AUTOTB_DUT      img_filter_hw
`define AUTOTB_DUT_INST AESL_inst_img_filter_hw
`define AUTOTB_TOP      apatb_img_filter_hw_top
`define AUTOTB_LAT_RESULT_FILE "img_filter_hw.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "img_filter_hw.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_img_filter_hw_top
...
`define AUTOTB_TVIN_in_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_in_V_data_V.dat"
`define AUTOTB_TVIN_in_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_in_V_keep_V.dat"
`define AUTOTB_TVIN_in_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_in_V_strb_V.dat"
`define AUTOTB_TVIN_in_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_in_V_user_V.dat"
`define AUTOTB_TVIN_in_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_in_V_last_V.dat"
`define AUTOTB_TVIN_in_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_in_V_id_V.dat"
`define AUTOTB_TVIN_in_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_in_V_dest_V.dat"
`define AUTOTB_TVIN_out_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_out_V_data_V.dat"
`define AUTOTB_TVIN_out_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_out_V_keep_V.dat"
`define AUTOTB_TVIN_out_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_out_V_strb_V.dat"
`define AUTOTB_TVIN_out_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_out_V_user_V.dat"
`define AUTOTB_TVIN_out_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_out_V_last_V.dat"
`define AUTOTB_TVIN_out_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_out_V_id_V.dat"
`define AUTOTB_TVIN_out_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvin_out_V_dest_V.dat"
...
`define AUTOTB_TVOUT_out_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvout_out_V_data_V.dat"
`define AUTOTB_TVOUT_out_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvout_out_V_keep_V.dat"
`define AUTOTB_TVOUT_out_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvout_out_V_strb_V.dat"
`define AUTOTB_TVOUT_out_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvout_out_V_user_V.dat"
`define AUTOTB_TVOUT_out_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvout_out_V_last_V.dat"
`define AUTOTB_TVOUT_out_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvout_out_V_id_V.dat"
`define AUTOTB_TVOUT_out_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.img_filter_hw.autotvout_out_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 615999;
