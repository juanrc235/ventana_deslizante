...
if {[file isfile img_filter_hw.autotvin.dat]} {
	file delete -force img_filter_hw.autotvin.dat
}

if {[file isfile img_filter_hw.autotvout.dat]} {
	file delete -force img_filter_hw.autotvout.dat
}
